...
import rainy from "../../assets/3d/rain_2.glb";

const Rain = (props) => {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(rainy);
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group
            name="4365ba478e234d39b808b54f5f965876fbx"
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="rain" rotation={[-Math.PI / 2, 0, 0]} scale={2.54}>
                  ...
                  <group
                    name="Plane003"
                    position={[26.075, -22.578, 189.936]}
                    scale={0.553}
                  >
                  ...
                  <group
                    name="Plane006"
                    position={[53.896, 38.917, 189.936]}
                    scale={0.553}
                  >
